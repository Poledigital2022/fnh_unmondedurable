...
let buttonDon = $('button[class="clickButtonDon"]'),
    ...
    spanDeductionIf = $('.deduction-if span'),
    buttonValue = 500
$('button[value="500"]').addClass('buttonDon-clicked')
spanDeduction.prepend(buttonValue-(buttonValue*66/100))
spanDeductionIf.prepend(buttonValue-(buttonValue*75/100))
buttonDon.click(function(){
    ...
    spanDeductionIf.empty()
    spanDeductionIf.prepend(buttonValue-(buttonValue*75/100).toFixed(0))
...
$('.valueSelect').click(function() {
    $('a.liendon').attr('href', 'https://dons.fnh.org/lp-ecoacteur-gd/fill?engagement=don_simple&montant='+buttonValue)
})
